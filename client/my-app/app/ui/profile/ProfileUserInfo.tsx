...
const ProfileUserInfo: React.FC<ProfileUserInfoProps> = ({
  ...
  return (
    <View style={styles.profileInfoContainer}>
      ...
      {/* Secțiunea de biografie și informații */}
      <View style={styles.bioSection}>
        <Text style={styles.username}>
          {profile?.username || user?.username || 'Nume utilizator indisponibil'}
        </Text>
      ...
      <View style={styles.actionButtonsContainer}>
        ...
        <TouchableOpacity 
          ...
          accessibilityLabel="Distribuie profil"
          accessibilityHint="Distribuie acest profil cu alți utilizatori"
        >
